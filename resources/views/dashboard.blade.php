                            ...
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{ $dataMasuk }}</h6>
                                            <span class="text-muted small pt-2 ps-1"><a href="/laporanmasuk">Cek
                                                    Selengkapnya</span>
                            ...
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{ $dataSelesai }}</h6>
                                            <span class="text-muted small pt-2 ps-1"><a href="/laporan">Cek
                                                    Selengkapnya</span>
                                            <i class="bi bi-arrow-right-circle"></i></a>
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{ $totalBerita }}</h6>
                                            <span class="text-muted small pt-2 ps-1"><a href="/berita">Cek
                                                    Selengkapnya</span>
                                            <i class="bi bi-arrow-right-circle"></i></a>
