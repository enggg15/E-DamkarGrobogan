...
<div class="modal-body">
    ...
    <form class="form-validate" id="artikeledukasiform" method="POST" action="{{ route('kelolaadmin.store') }}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          ...
          <select class="form-select" id="inputGroupSelect01" name="kedudukans_id">
            ...
            <div class="modal-body">
                ...
                method="POST">
                  ...
                  <select class="form-select" id="inputGroupSelect01" name="kondisi_cuaca_id">
                        <option @if($admin->kedudukans_id == null) selected @endif>Pilih...</option>
                        <option value="2" @if($admin->kedudukans_id == 2) selected @endif>Admin</option>
                        <option value="3" @if($admin->kedudukans_id == 3) selected @endif>User</option>
                  </select>
                        </div>
                        </div>
                    </div>
