...
<head>
    ...
    <title>{{ $title ?? config('E-Damkar|Grobogan') }}</title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/dashboard" class="logo d-flex align-items-center">
                <img src="/" alt="">
                <span class="d-none d-lg-block">E-DAMKAR Grobogan</span>
            </a>
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                @php $kedudukans_id = Auth::user()->kedudukans_id; @endphp
                @if ($kedudukans_id == 1 || $kedudukans_id == 2)
                <li class="nav-item dropdown">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>E-Damkar Grobogan</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#myModalinfoupdate">Update</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="myModalinfoupdate" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Bagian body modal -->
                <div class="modal-body">
                    <form method="POST" action="{{ route('pengaturan.updateprofil') }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama_lengkap" id="nama_lengkap"
                                    value="{{ Auth::user()->nama_lengkap }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="no_hp" id="no_hp"
                                    value="{{ Auth::user()->noHp }}" class="form-control" required>
                            </div>
                        </div>
