                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $laporan)
                                            @php echo $laporan->detailLaporanPengguna->admin_damkars; @endphp
                                            <tr>
                                                <th scope="row">{{ $no++ }}</th>
                                                <td>{{ date('d-m-Y', strtotime($laporan->detailLaporanPengguna->tgl_pelaporan)) }}
                                                    ({{ $laporan->detailLaporanPengguna->waktu_pelaporan }})
                                                </td>
                                                ...
                                                <td><a href="#" type="button" class="btn btn-primary"
                                                        ...
                                                        data-bs-target="#largeModalTampil{{ $laporan->idLaporan }}">Cek
                                                        Detail
                                                </td>
                                                <td>
